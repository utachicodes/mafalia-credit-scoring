...
const baseTranslations = {
  ...
  loans: {
    ...
    summary: {
      ...
      platformInterest: "Platform Interest (2 pts)",
      lenderInterest: "Lender Interest",
    },
    calculator: {
  ...
  wallet: {
    ...
    forms: {
      ...
      destinationKindLabel: "Destination",
      destinationKindWallet: "Mobile wallet",
      destinationKindBank: "Bank account",
      ibanLabel: "IBAN",
  ...
  fr: {
    ...
    loans: {
      ...
      summary: {
        ...
        creditRating: "Votre notation de crédit",
        interestSuffix: "TAEG",
      totalRepayable: "Total à rembourser",
      platformInterest: "Intérêts plateforme (2 pts)",
      lenderInterest: "Intérêts prêteur",
      },
      calculator: {
    ...
    copied: "Copié",
      ...
      forms: {
        ...
        destinationKindLabel: "Destination",
        destinationKindWallet: "Portefeuille mobile",
        destinationKindBank: "Compte bancaire",
        ibanLabel: "IBAN",
        accountNumberLabel: "Numéro de compte",
        referenceLabel: "Référence (optionnel)",
        submitTopUp: "Confirmer la recharge",
    ...
    filters: {
      ...
      toasts: {
        ...
        withdrawSuccess: "Retrait demandé",
